...
import com.git.mur.efdf.efdfThirstBar.efdfDrinkItem;
import com.git.mur.efdf.efdfThirstBar.efdfDrinkItemConsumption;
...
public class efdfFood {
    ...
    public static final Item COMPRESSED_BISCUITS_ITEM = new efdfDrinkItemConsumption(new Item.Settings().food(COMPRESSED_BISCUITS).maxCount(12));
    //红烧牛肉罐头，力量1，持续60秒，回复16饥饿值（两块熟牛肉）
    public static final FoodComponent BRAISED_BEEF_CAN = (new FoodComponent.Builder()).hunger(16).saturationModifier(25.6f).alwaysEdible()
    ...
    public static final FoodComponent BRAISED_BEEF_CAN_SMALL = (new FoodComponent.Builder()).hunger(8).saturationModifier(16f).alwaysEdible()
